...
const EncryptButton = ({
  ...
  return (
    <motion.button
      ...
      onClick={onClick}
      className="group ring-offset-background focus-visible:ring-ring relative cursor-pointer overflow-hidden rounded-md bg-neutral-700 px-4 py-2 font-mono font-medium text-neutral-300 uppercase transition-colors hover:text-[#01a2a4] focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50"
    >
