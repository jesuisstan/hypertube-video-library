...
function SidebarTrigger({ className, onClick, ...props }: React.ComponentProps<typeof ButtonShad>) {
...
function SidebarMenuItem({
  ...
  return (
    <li
      ...
      className={cn('group/menu-item relative', isActive && 'font-semibold', className)}
      {...props}
    />
  );
}
