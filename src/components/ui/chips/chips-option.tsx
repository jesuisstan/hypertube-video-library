...
const ChipsOption = ({
  ...
  return (
    <div
      ...
      className={clsx(
        `flex h-5 min-w-[54px] flex-row items-center justify-center gap-1 whitespace-nowrap break-words rounded-3xl border-[1px] border-muted-foreground px-[9px] py-[2px] text-center text-xs font-normal normal-case leading-loose transition-all duration-300 ease-in-out`,
