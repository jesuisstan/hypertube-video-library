    ...
    return (
      <div className={className}>
        <input
          ...
          className={cn(
            'flex h-10 w-full rounded-md border bg-input px-3 py-2 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary focus-visible:ring-offset-0 disabled:cursor-not-allowed disabled:opacity-50',
        ...
        <span className={cn('text-xs text-destructive', showError ? 'opacity-100' : 'opacity-0')}>
          {errorMessage || '\u00A0'}
        </span>
      </div>
    );
